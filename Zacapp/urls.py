...
urlpatterns = [
    ...
    path('remove-from-cart/<int:product_id>/<str:selected_size>', views.remove_from_cart, name='remove_from_cart'),
    path('add-to-cart/<int:product_id>/<str:selected_size>', views.add_to_cart, name='add_to_cart'),
]